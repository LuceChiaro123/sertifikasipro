...
class Asesi(Base):
    ...
    sertifikat_pelatihan_url = Column(String(512), nullable=True)
    # Data diri lengkap (field APL-01 tambahan: tempat/tgl lahir, jenis kelamin,
    # kebangsaan, kode pos, data pekerjaan kantor, dll.) — sumber tunggal form.
    profil_json = Column(JSONType, nullable=False, default=dict)
